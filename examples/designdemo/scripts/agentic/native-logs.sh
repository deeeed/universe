...
# Android log filter
ANDROID_FILTER='ReactNative|ReactNativeJS|Expo'

# iOS log filter
IOS_PREDICATE='eventMessage CONTAINS "ReactNative" OR eventMessage CONTAINS "Expo"'

usage() {
  cat <<'EOF'
native-logs.sh — Retrieve native logs from Android/iOS devices
